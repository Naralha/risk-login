...
export class FeaturesComponent implements OnInit {
  ...
  constructor(protected featuresService: FeaturesService, protected modalService: NgbModal) {}
  ...
  delete(features: IFeatures): void {
    const modalRef = this.modalService.open(FeaturesDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
