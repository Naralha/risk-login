...
describe('Features Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Features', () => {
      ...
      service.create(new Features()).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addFeaturesToCollectionIfMissing', () => {
      ...
      it('should not add a Features to an array that contains it', () => {
        ...
        expectedResult = service.addFeaturesToCollectionIfMissing(featuresCollection, features);
      ...
      it('should add only unique Features to an array', () => {
        const featuresArray: IFeatures[] = [{ id: 123 }, { id: 456 }, { id: 16409 }];
        const featuresCollection: IFeatures[] = [{ id: 123 }];
        expectedResult = service.addFeaturesToCollectionIfMissing(featuresCollection, ...featuresArray);
      ...
      it('should accept varargs', () => {
        ...
        expectedResult = service.addFeaturesToCollectionIfMissing([], features, features2);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(features);
      ...
      it('should accept null and undefined values', () => {
        const features: IFeatures = { id: 123 };
        expectedResult = service.addFeaturesToCollectionIfMissing([], null, features, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(features);
      });
      ...
      it('should return initial array if no Features is added', () => {
        const featuresCollection: IFeatures[] = [{ id: 123 }];
        expectedResult = service.addFeaturesToCollectionIfMissing(featuresCollection, undefined, null);
